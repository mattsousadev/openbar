...
class ImportWordsAdapter():
    def adapt(self, request: module_request.Request) -> module_model_controller_import_words.ImportWordsRequest:
        file_path = request.body['file_dir']
        return module_model_controller_import_words.ImportWordsRequest(file_path)